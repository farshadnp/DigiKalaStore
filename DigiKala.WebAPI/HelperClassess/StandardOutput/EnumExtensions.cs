using DigiKala.WebAPI.HelperClassess.StandardOutput;
using System;
...
namespace DigiKala.WebAPI.HelperClassess.StandardOutput
{
    ...
    public enum DefineCategory
    {
        [Display(Name = "گروه شغلی")]
        JobCategory = 1,
        [Display(Name = "جنسیت")]
        Gender = 2,
        [Display(Name = "رنگ مورد علاقه")]
        Color = 3,
        [Display(Name = "دلایل ارسال کد")]
        SendCodeReason = 4,
    }
    public enum SendCodeReason
    {
        [Display(Name = "عضویت در سامانه")]
        Registration = 12,
        [Display(Name = "ورود")]
        Login = 13,
